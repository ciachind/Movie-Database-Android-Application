...
{
    // interface implemented by MoviesFragment to respond
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(View itemView)
        {
            ...
            itemView.setOnClickListener
                    ...
                    {
                        // executes when the movie in this ViewHolder is clicked
                        @Override
        ...
        // set the database row ID for the movie in this ViewHolder
    ...
    // MoviesAdapter instance variables
